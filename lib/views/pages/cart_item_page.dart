...
class CartItemPage extends StatefulWidget {
  const CartItemPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(child: Text(prod.isEmpty&&discountProd.isEmpty?"":(prod.isEmpty?discountProd[0]["title"]:prod[0]["title"]), style: const TextStyle(color: Colors.black, fontWeight: FontWeight.bold),)),
      ),
      body: prod.isEmpty&&discountProd.isEmpty?const CustomLoader():Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Center(
                child: Padding(
                  padding: EdgeInsets.all(Dimensions.width10),
                  child: Text("N ${prod.isEmpty?discountProd[0]["price"]:prod[0]["price"]}",
                    maxLines: 1,
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(color: Colors.black,
                        fontWeight: FontWeight.bold, fontSize: Dimensions.font26),),
